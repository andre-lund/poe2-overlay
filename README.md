...
> Status: **feature-complete, in-game verification pending** (T1–T10). Everything
> below is code-complete and reviewed; T1–T3 are user-confirmed in-game, T4–T10 await
